...
The Cooragent CLI tool now supports the Windows platform. However, we recommend using Linux, macOS, or Windows Subsystem for Linux (WSL) for local development and deployment.
